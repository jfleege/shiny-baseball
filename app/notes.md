...
I thought that a few notes about the app and statistics themselves as they relate to the game might help the user experience. Here I've included information on the selection options, as well as information on how to read the plots. Not all of the variables provided by the Lahman Baseball Database have definitions, but the included ones should provide a good start.

For more information in regard to the Lahman Baseball Database, that link can be found [here](https://sabr.org/lahman-database/) for those interested.

## Standard Stats

\*Note — all definitions uses are provided by the official MLB website, which can be found [here](https://www.mlb.com/glossary/standard-stats).
